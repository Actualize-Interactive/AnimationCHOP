...
public:
	...
	virtual int32_t		getNumInfoCHOPChans([[maybe_unused]] void* reserved1) override;
	virtual void		getInfoCHOPChan(int index,
										OP_InfoCHOPChan* chan,
										[[maybe_unused]] void* reserved1) override;

	virtual bool		getInfoDATSize(OP_InfoDATSize* infoSize, [[maybe_unused]] void* reserved1) override;
