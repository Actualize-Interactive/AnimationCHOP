...
// Forward declarations of PyPoint2D methods
...
// Point2D attribute getters/setters
...
PyPoint2D* Point2DToPyPoint2D(const anim::Point2D& point) {
...
PyObject* Point2DToPyObject(const anim::Point2D& point) {
    PyPoint2D* pyPoint = Point2DToPyPoint2D(point);
    return (PyObject*)pyPoint;
}

bool PyObjectToPoint2D(PyObject* obj, anim::Point2D& point) {
...
PyObject* get_point2d_type(PyObject* self, void* closure) {
